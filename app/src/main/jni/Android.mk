...
LOCAL_MODULE    := MY_EX_NUSRAT_IS_MY_LOVE
...
LOCAL_C_INCLUDES += $(LOCAL_PATH)/foxcheats/include
LOCAL_C_INCLUDES += $(LOCAL_PATH)/ResetCD

LOCAL_STATIC_LIBRARIES := libdobby libfoxcheats
